...
if (vidaRestant >= 75) {
    probVictoria = 100
} else if (vidaRestant >= 50 && vidaRestant < 75)  {
    probVictoria = 75
} else if (vidaRestant >= 25 && vidaRestant < 50)  {
    probVictoria = 50
} else {
    probVictoria = 10
}
...
const probVic = document.querySelector('#prob-victoria');
probVic.textContent = `${probVictoria}%`; 
